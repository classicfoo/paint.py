...
class PaintApp:
    def __init__(self, root):
        ...
        self.color_buttons_frame.pack(side=tk.LEFT, padx=10)
        
        self.create_color_button('dark red', 'dark red')
        self.create_color_button('navy', 'navy')
        self.create_color_button('dark green', 'dark green')
        self.create_color_button('black', 'black')

        self.color_button = tk.Button(self.root, text="Color", command=self.choose_custom_color)
    ...
    def create_color_button(self, text, color):
        color_button = tk.Button(self.color_buttons_frame, text='', width=2, height=0, bg=color, command=lambda c=color: self.choose_color(c))
